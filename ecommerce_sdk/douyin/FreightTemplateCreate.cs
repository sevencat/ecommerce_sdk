...
[DouyinRetCode(50002,"业务处理失败","423:请至少选择一个非港澳台地区允许下单","isv.business-failed:423","-")]
public class FreightTemplateCreateReq : IDouyinReq<FreightTemplateCreateRsp>
{

	public string GetMethod() { return "freightTemplate.create"; }

	public string GetUrl() { return "/freightTemplate/create"; }
...
[Description("创建运费模板")]
public class FreightTemplateCreateRsp
{
	[JsonPropertyName("template_id")]
	[Description("创建的模板的id")]
