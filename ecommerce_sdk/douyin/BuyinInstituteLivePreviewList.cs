...
[Description("抖客获取直播预告及直播预告商品信息列表")]
[DouyinRetCode(10000,"success","","","")]
[DouyinRetCode(40004,"非法的参数","无效分页大小","isv.parameter-invalid:4127","参数校验失败: 无效分页大小")]
...
[DouyinRetCode(40004,"非法的参数","达人未开通分销业务","isv.parameter-invalid:4129","请输入开通分销业务的达人buyinId")]
[DouyinRetCode(40004,"非法的参数","当前达人没有直播预告功能权限","isv.parameter-invalid:4109","请输入开通直播预告权限的达人buyinId")]
[DouyinRetCode(50002,"业务处理失败","需【抖客】角色授权后访问","isv.business-failed:8194","需【抖客】角色授权后访问")]
public class BuyinInstituteLivePreviewListReq : IDouyinReq<BuyinInstituteLivePreviewListRsp>
{

	public string GetMethod() { return "buyin.instituteLivePreviewList"; }

	public string GetUrl() { return "/buyin/instituteLivePreviewList"; }

	[JsonPropertyName("buyin_id")]
	[Description("要查询的达人的百应ID")]
	[NotNull]
	...
	[Description("每页直播预告数量，最大100")]
	public int? PageSize { get; set; }
}

[Description("抖客获取直播预告及直播预告商品信息列表")]
public class BuyinInstituteLivePreviewListRsp
{
	...
	public class PreviewsItem
	{
		...
		public class ProductsItem
		{
			...
			public class AdsPromotionRatioItem
			{
				...
				[Description("新客推广费率，返回结果X10000，如10%返回1000")]
				public long ShareRatio { get; set; }

				[JsonPropertyName("old_fans_ratio")]
				[Description("老客推广费率，返回结果X10000，如10%返回1000")]
