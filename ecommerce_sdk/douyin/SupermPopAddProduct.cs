...
public class SupermPopAddProductReq : IDouyinReq<SupermPopAddProductRsp>
{

	public string GetMethod() { return "superm.pop.addProduct"; }

	public string GetUrl() { return "/superm/pop/addProduct"; }
...
[Description("小时达营销活动添加商品")]
public class SupermPopAddProductRsp
{
	[JsonPropertyName("sd_activity_id")]
	[Description("活动id")]
	public string SdActivityId { get; set; }
