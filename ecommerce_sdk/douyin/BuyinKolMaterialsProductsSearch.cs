...
[Description("本接口用于检索小店联盟商品。可根据筛选条件过滤出满足条件的商品，也可根据排序条件对检索出来的商品进行排序。接口返回的商品列表会受授权达人推荐策略的影响，同时响应结果增加了达人佣金率和佣金。")]
[DouyinRetCode(10000,"success","","","")]
[DouyinRetCode(40004,"非法的参数","参数校验失败: 无效搜索类型","isv.parameter-invalid:4098","无效搜索类型")]
[DouyinRetCode(40004,"非法的参数","参数校验失败: 无效分页大小","isv.parameter-invalid:4097","无效分页大小")]
[DouyinRetCode(20000,"系统错误","服务打瞌睡了，请稍后再试","isp.service-error:256","服务打瞌睡了，请稍后再试")]
[DouyinRetCode(50002,"业务处理失败","无效百应ID","isv.business-failed:4173","请重新授权")]
public class BuyinKolMaterialsProductsSearchReq : IDouyinReq<BuyinKolMaterialsProductsSearchRsp>
{

	public string GetMethod() { return "buyin.kolMaterialsProductsSearch"; }

	public string GetUrl() { return "/buyin/kolMaterialsProductsSearch"; }
...
[Description("本接口用于检索小店联盟商品。可根据筛选条件过滤出满足条件的商品，也可根据排序条件对检索出来的商品进行排序。接口返回的商品列表会受授权达人推荐策略的影响，同时响应结果增加了达人佣金率和佣金。")]
public class BuyinKolMaterialsProductsSearchRsp
{
