...
[DouyinRetCode(50002,"业务处理失败","业务错误","isv.business-failed:1400","请重试")]
[DouyinRetCode(50002,"业务处理失败","参数错误","isv.business-failed:1006","请使用秒级时间戳")]
public class YuncSyncInventoryLogFlowV2Req : IDouyinReq<YuncSyncInventoryLogFlowV2Rsp>
{

	public string GetMethod() { return "yunc.syncInventoryLogFlowV2"; }

	public string GetUrl() { return "/yunc/syncInventoryLogFlowV2"; }
...
[Description("外部同步库存流水V2")]
public class YuncSyncInventoryLogFlowV2Rsp
{
}
