...
public class SupermPopDelProductReq : IDouyinReq<SupermPopDelProductRsp>
{

	public string GetMethod() { return "superm.pop.delProduct"; }

	public string GetUrl() { return "/superm/pop/delProduct"; }
...
[Description("小时达营销活动-删除商品")]
public class SupermPopDelProductRsp
{
	[JsonPropertyName("sd_activity_id")]
	[Description("活动id")]
	public string SdActivityId { get; set; }
