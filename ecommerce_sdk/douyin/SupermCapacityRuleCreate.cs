...
[Description("门店时段容量添加（组织维度或组织下门店维度）")]
...
public class SupermCapacityRuleCreateReq : IDouyinReq<SupermCapacityRuleCreateRsp>
{

	public string GetMethod() { return "superm.capacityRule.create"; }

	public string GetUrl() { return "/superm/capacityRule/create"; }
...
[Description("门店时段容量添加（组织维度或组织下门店维度）")]
public class SupermCapacityRuleCreateRsp
{
}
