...
[DouyinRetCode(50002,"业务处理失败","参数非法","isv.business-failed:602","请检查网络")]
...
public class OpenCloudDdpDeleteShopReq : IDouyinReq<OpenCloudDdpDeleteShopRsp>
{

	public string GetMethod() { return "openCloud.ddpDeleteShop"; }

	public string GetUrl() { return "/openCloud/ddpDeleteShop"; }

	[JsonPropertyName("shop_id")]
	[Description("需要解除推送的店铺ID")]
	[NotNull]
	public long? ShopId { get; set; }
}

[Description("数据推送，删除绑定的推送店铺。")]
public class OpenCloudDdpDeleteShopRsp
{
}
