...
[DouyinRetCode(40002,"缺少必选参数","缺少必填参数","isv.missing-parameter:1001","根据提示填写必填参数")]
[DouyinRetCode(50002,"业务处理失败","1003:业务处理失败","isv.business-failed:1003","根据提示处理")]
[DouyinRetCode(50002,"业务处理失败","1004:业务处理失败","isv.business-failed:1004","根据提示处理")]
public class YuncSyncInventorySnapshotReq : IDouyinReq<YuncSyncInventorySnapshotRsp>
{

	public string GetMethod() { return "yunc.syncInventorySnapshot"; }

	public string GetUrl() { return "/yunc/syncInventorySnapshot"; }
...
[Description("库存快照回传")]
public class YuncSyncInventorySnapshotRsp
{
