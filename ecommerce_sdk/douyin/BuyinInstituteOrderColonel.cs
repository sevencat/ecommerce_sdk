...
[Description("查询团长抖音、火山、头条和西瓜订单，需要团长百应授权")]
...
[DouyinRetCode(50002,"业务处理失败","账号状态异常，请检查账号状态","isv.business-failed:4200","请检查账号是否可以正常使用，比如是否完成协议签署、是否被清退/关闭等")]
public class BuyinInstituteOrderColonelReq : IDouyinReq<BuyinInstituteOrderColonelRsp>
{

	public string GetMethod() { return "buyin.instituteOrderColonel"; }

	public string GetUrl() { return "/buyin/instituteOrderColonel"; }
...
[Description("查询团长抖音、火山、头条和西瓜订单，需要团长百应授权")]
public class BuyinInstituteOrderColonelRsp
{
	...
	public class DataItem
	{
		...
		public class OrdersItem
		{
			...
			[Description("APP ID(1128:抖音，2329:抖音极速版，1112: 火山，32: 西瓜， 13: 头条)")]
			...
			[Description("独立抖客推广费率，此处保存为真实数据x1万之后，如真实是0.35，这里是3500")]
			...
			public class ColonelOrderInfoItem
			{
				...
				[Description("团长技术服务费率，单位分")]
				public long TechServiceFeeRate { get; set; }

				[JsonPropertyName("tech_service_fee")]
				[Description("团长预估技术服务费，单位分")]
				public long TechServiceFee { get; set; }

				[JsonPropertyName("settled_tech_service_fee")]
				[Description("团长结算技术服务费，单位分")]
			...
			[JsonPropertyName("colonel_type")]
			[Description("团长类型。0：普通；1:一级团长；2: 二级团长")]
			public string ColonelType { get; set; }

			[JsonPropertyName("colonel_order_info_second")]
			[Description("二级团长信息")]
			public ColonelOrderInfoSecondItem ColonelOrderInfoSecond { get; set; }

			public class ColonelOrderInfoSecondItem
			{
				[JsonPropertyName("commission_rate")]
				[Description("二级团长服务费率(35%返回3500)")]
				public long CommissionRate { get; set; }
				...
				[JsonPropertyName("estimated_commission")]
				[Description("二级团长预估服务费，单位分")]
				public long EstimatedCommission { get; set; }

				[JsonPropertyName("real_commission")]
				[Description("二级团长结算服务费，单位分")]
				public long RealCommission { get; set; }

				[JsonPropertyName("institution_id")]
				[Description("二级团长机构ID")]
				public long InstitutionId { get; set; }

				[JsonPropertyName("institution_name")]
				[Description("二级团长机构名称")]
				public string InstitutionName { get; set; }
			...
			[JsonPropertyName("is_trusteeship")]
			[Description("是否托管")]
			public bool IsTrusteeship { get; set; }

			[JsonPropertyName("good_share_type")]
			[Description("分销类型。ProductDetail：商品分销；Live：直播分销；Activity：频道活动；Mix：营销活动")]
			public string GoodShareType { get; set; }
		}
