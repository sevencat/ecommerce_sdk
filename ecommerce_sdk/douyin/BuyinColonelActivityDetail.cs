...
[Description("接口用于团长查询指定团长活动的活动详情，支持查询自建团长活动和可参与报名的团长活动详情")]
...
public class BuyinColonelActivityDetailReq : IDouyinReq<BuyinColonelActivityDetailRsp>
{

	public string GetMethod() { return "buyin.colonelActivityDetail"; }

	public string GetUrl() { return "/buyin/colonelActivityDetail"; }
...
[Description("接口用于团长查询指定团长活动的活动详情，支持查询自建团长活动和可参与报名的团长活动详情")]
public class BuyinColonelActivityDetailRsp
{
	...
	[Description("报名门槛-店铺体验分选项。0表示不限")]
