...
public class SupermPopQueryStoreCouponListReq : IDouyinReq<SupermPopQueryStoreCouponListRsp>
{

	public string GetMethod() { return "superm.pop.queryStoreCouponList"; }

	public string GetUrl() { return "/superm/pop/queryStoreCouponList"; }
...
[Description("小时达-查询门店优惠列表")]
public class SupermPopQueryStoreCouponListRsp
{
