...
[DouyinRetCode(20000,"系统错误","编辑商品失败：接口限流","isp.service-error:2010401","稍后重试")]
...
public class ProductEditCbProductV2Req : IDouyinReq<ProductEditCbProductV2Rsp>
{

	public string GetMethod() { return "product.editCbProductV2"; }

	public string GetUrl() { return "/product/editCbProductV2"; }
	...
	[Description("是否支持7天无理由，0不支持，1支持，2支持（拆封后不支持）")]
...
[Description("编辑一个跨境/海南商品")]
public class ProductEditCbProductV2Rsp
{
}
